...
Use this as a reference when formatting each function entry:
...
This template applies regardless of language. Adapt parameter table columns
and code block language tag to match the source.
